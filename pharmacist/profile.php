...
$pharmacist_id = $user_data['user_id'] ?? 'N/A';
$pharmacist_name = $user_data['full_name'] ?? 'Pharmacist';
$pharmacist_email = $user_data['email'] ?? 'N/A';
...
?>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <p><strong>Name:</strong> <?php echo htmlspecialchars($pharmacist_name); ?></p>
                    <p><strong>Email:</strong> <?php echo htmlspecialchars($pharmacist_email); ?></p>
                    <p><strong>Pharmacist ID:</strong> <?php echo htmlspecialchars($pharmacist_id); ?></p>
                </div>
            </div>
                ...
                <div class="card-content">
                    <form id="updateProfileForm">
                        <div class="form-group">
                            ...
                            <input type="text" id="fullName" name="fullName" value="<?php echo htmlspecialchars($pharmacist_name); ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($pharmacist_email); ?>" required>
                        </div>
