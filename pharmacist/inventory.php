                ...
                <header class="page-header">
                    ...
                    <div class="user-info" style="display: flex; align-items: center; gap: 15px;">
                        <div>
                            ...
                            <span style="font-size: 0.85rem; color: var(--text-secondary);">Inventory Management</span>
                        </div>
