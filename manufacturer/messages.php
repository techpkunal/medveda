...
<body>
            ...
            <aside class="sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul>
                        ...
                        <li><a href="messages.php"><svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg><span>Messages</span></a></li>
            ...
            <main class="main-content">
                <header class="page-header">
                     ...
                     <div class="user-info" style="display: flex; align-items: center; gap: 15px;">
                         <!-- <div>
                             <strong>Welcome, <?php echo htmlspecialchars($manufacturer_name); ?></strong><br>
                             <span style="font-size: 0.85rem; color: var(--text-secondary);">Manufacturer Dashboard</span>
                        </div>
                ...
                <!-- Sent Messages Card -->
                <!-- <div class="card">
                    <h3 class="card-header"><svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>Sent Messages</h3>
                    <div style="overflow-x:auto;">
                        <table class="messages-table">
                            <thead>
                                <tr>
    ...
    <script>
        ...
        const manufacturerId = <?php echo $manufacturer_id; ?>;
        ...
        async function loadMessages() {
            ...
            try {
                const response = await fetch(`../api/get_messages.php?user_id=${manufacturerId}`);
        ...
        async function loadSentMessages() {
            ...
            try {
                const response = await fetch(`../api/get_sent_messages.php?sender_id=${manufacturerId}`);
                const data = await response.json();
        ...
        async function markMessageAsRead(messageId) {
            try {
                const response = await fetch('../api/mark_message_read.php', {
                    ...
                    body: JSON.stringify({ message_id: messageId, user_id: manufacturerId })
                });
                const data = await response.json();
                if (!data.success) {
